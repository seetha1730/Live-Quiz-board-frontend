 ...
 <nav className="bg-gray-800">
        ...
        <div className="flex items-center">
          ...
          <div className="hidden md:block">
            ...
            <NavLink to="/"  className="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" >
                ...
                <NavLink to="/projects" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium" >
                  Projects
                </NavLink>
  ...
  <NavLink to="/login" className=" text-white  px-3 py-2 text-sm font-medium"> <button>Login</button> </NavLink>
            ...
            <div className="relative ml-3">
              ...
              <div id="user-menu" className="invisible dropdown-menu absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" tabIndex="-1">
